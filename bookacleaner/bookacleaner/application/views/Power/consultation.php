                ...
                <div class="row">
                    <div class="col-sm-3">
                        <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" class="form-control" style="margin-bottom: 10px;">
                            <option value="" selected="">Online Consultation</option>
                            <option value="./consultation_requests">Online Consultation Requests</option>
                        </select>
                    </div>
                </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function(){
                        var calendar = $('#calendar').fullCalendar({
                            ...
                            events:"<?php echo base_url() .'index.php/'. $textss; ?>/getConsultation",
                            selectable:true,
                            selectHelper:true,
